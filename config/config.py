...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Kora Music")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AbhiMod/music",
)
...
STATS_IMG_URL = getenv(
    "STATS_IMG_URL","https://graph.org/file/f45d9b5c660fda58cb83c.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/pchk.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "assets/plist.jpeg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "assets/gstats.jpeg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "assets/gstats.jpeg":
