    ...
    try:
        ...
        try:
            ...
            text_w, text_h = draw.textsize(
                f"AM Music One Of The Most Advanced Telegram Music Bot", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"AM Music One Of The Most Advanced Telegram Music Bot",
                fill="green",
                font=arial,
            )
            if para[0]:
            ...
            pass
        text_w, text_h = draw.textsize(f"YouTube: AM Music", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 620),
            f"YouTube: AM Music",
            fill="white",
